...
export class SelectionEventsHelper {
    ...
    keyboardHandler(ctrlKeyPressed, shiftKeyPressed, keyCode) {
        switch (keyCode) {
     ...
     * @returns `true` if any of executed commands was applied.
     */
    mouseHandler(ctrlKeyPressed, shiftKeyPressed, mouseButton, itemIndex) {
     ...
     */
    trySelectAll(ctrlPressed, shiftPressed) {
     ...
     * @returns `true` if command was applied.
     */
    trySelectPreviousItem(shiftKeyPressed) {
     ...
     * @returns `true` if command was applied.
     */
    trySelectNextItem(shiftKeyPressed) {
     ...
     * @returns `true` if command was applied.
     */
    tryDeselectLastItemInRange(shiftKeyPressed) {
     ...
     * @returns `true` if command was applied.
     */
    tryDeselectLastItemInReversedRange(shiftKeyPressed) {
     ...
     * @returns `true` if command was applied.
     */
    tryBuildRangeWithPreviousItemWhenLastItemWasDeselected(ctrlKeyPressed, shiftKeyPressed) {
        if (!ctrlKeyPressed &&
            shiftKeyPressed &&
     ...
     * @returns `true` if command was applied.
     */
    tryBuildRangeWithNextItemWhenLastItemWasDeselected(ctrlKeyPressed, shiftKeyPressed) {
        if (!ctrlKeyPressed &&
            shiftKeyPressed &&
            false === this.selectionService.isIndexSelected(this.selectionService.lastProcessedIndex)) {
            this.selectionService.selectRange(this.selectionService.lastProcessedIndex, this.selectionService.lastProcessedIndex + 1);
     ...
     * @returns `true` if command was applied.
     */
    tryInitialSelectionOfFirstItem() {
     ...
     * @returns `true` if command was applied.
     */
    trySelectAllItemsUpToFirst(ctrlKeyPressed, shiftKeyPressed) {
     ...
     * @returns `true` if command was applied.
     */
    trySelectAllItemsUpToLast(ctrlKeyPressed, shiftKeyPressed) {
        if (this.selectionService.lastProcessedIndex !== null && ctrlKeyPressed && shiftKeyPressed && this.multiple) {
     ...
     * @returns `true` if command was applied.
     */
    trySelectFirstItem(ctrlKeyPressed, shiftKeyPressed) {
     ...
     * @returns `true` if command was applied.
     */
    trySelectLastItem(ctrlKeyPressed, shiftKeyPressed) {
        if (ctrlKeyPressed && !shiftKeyPressed) {
     ...
     * @returns `true` if any of executed commands was applied.
     */
    onPreviousKey(ctrlKeyPressed, shiftKeyPressed) {
     ...
     * @returns `true` if any of executed commands was applied.
     */
    onNextKey(ctrlKeyPressed, shiftKeyPressed) {
        return (this.tryInitialSelectionOfFirstItem() ||
